...
#else
            struct funcs { static bool IsLegacyNativeDupe(ImGuiKey key) { return (key < 512 && key >= 0) && (ImGui::GetIO().KeyMap[key] != -1); } }; // Hide Native<>ImGuiKey duplicates when both exists in the array
